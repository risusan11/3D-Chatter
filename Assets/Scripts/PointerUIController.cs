    ...
    void Update()
    {
        ...
        switch (drawingPlacer.CurrentMode)
        {
            ...
            case DrawingPlacer.PlayerMode.Default3DDraw:
                bool is3DMode   = (simple3DPainter != null && simple3DPainter.Is3DDrawingMode && simple3DPainter.enabled);
                bool is3DEraser = (simple3DPainter != null && simple3DPainter.IsEraserMode);
